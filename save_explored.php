<?php
  ...
  $list = array ($_POST['list_building'],$_POST['list_electric'],$_POST['list_inside'],$_POST['list_outside'],$_POST['list_computer'],$_POST['list_media']);
  $sublist_c = array("อาคารและสิ่งก่อสร้าง","ไฟฟ้า","ครุภัณฑ์ภายในห้องเรียน","ครุภัณฑ์ภายนอกห้องเรียน","คอมพิวเตอร์","สื่อการสอน");
